...
////// Emissive:
                float node_6761 = 0.0;
                float3 emissive = lerp((_FresnelBrightness*_Color.rgb),float3(node_6761,node_6761,node_6761),(1.0-pow(1.0-max(0,dot(i.normalDir, viewDirection)),_FresnelExponent)));
/// Final Color:
