...
////// Lighting:
////// Emissive:
                float node_6204 = 0.5*dot(viewDirection,i.normalDir)+0.5;
                float node_196 = 0.5;
                float node_7601_if_leA = step(node_6204,node_196);
                float node_7601_if_leB = step(node_196,node_6204);
